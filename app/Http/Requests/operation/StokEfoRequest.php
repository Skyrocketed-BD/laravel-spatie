...
class StokEfoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        if ($this->isMethod('post')) {
            $rules['dome_name']             = ['required', 'string', 'unique:operation.dom_efo,name'];
    ...
    public function messages(): array
    {
        return [
            ...
            'id_stok_eto.min'                => 'Minimal harus ada satu ID stok eto.',
        ];
    }
